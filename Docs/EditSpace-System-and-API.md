...
EditSpace is a language-neutral collaboration protocol for structured 3D editing. This repository is its reference implementation in Swift. Python will be the next implementation for a Blender plug-in.
